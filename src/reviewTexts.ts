...
export const GUEST_REVIEWS: GuestReview[] = [
  ...
  // Sholas Residency by Brown Tree Resorts — Ooty
  {
  ...
  // Humming Bird by Brown Tree Resorts — Kothagiri
  {
    property: "Humming Bird by Brown Tree Resorts",
  ...
  // Hotel Vetrivel International by Brown Tree Resorts — Kodaikanal
  {
    property: "Hotel Vetrivel International by Brown Tree Resorts",
    title: "Great service",
